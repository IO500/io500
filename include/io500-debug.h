...
#define INVALID(...) do{ if (opt.rank == 0){fprintf(file_out, "; ERROR INVALID "__VA_ARGS__); printf("ERROR INVALID "__VA_ARGS__); fflush(file_out); opt.is_valid_run = 0; } }while(0);
